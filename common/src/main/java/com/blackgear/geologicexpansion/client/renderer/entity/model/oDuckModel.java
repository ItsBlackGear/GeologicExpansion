...
import com.blackgear.geologicexpansion.client.renderer.entity.animation.oDuckAnimations;
...
public class oDuckModel<T extends Animal> extends HierarchicalModel<T> {
    ...
    public oDuckModel(ModelPart root) {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity instanceof ODuck duck) {
            this.animate(duck.floatTransformationState, oDuckAnimations.IN_WATER_TRANSFORM, ageInTicks, motionSpeed);
        }
    }
    ...
    public void prepareMobModel(T entity, float limbSwing, float limbSwingAmount, float partialTick) {
        ...
        if (entity instanceof ODuck duck) {
            this.head.y = 6.0F + duck.getHeadEatPositionScale(partialTick) * 9.0F;
            this.headXRot = duck.getHeadEatAngleScale(partialTick);
        }
    }
