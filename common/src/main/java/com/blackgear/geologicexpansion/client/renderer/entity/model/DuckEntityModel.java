...
import com.blackgear.geologicexpansion.client.renderer.entity.animation.DuckEntityAnimations;
...
public class DuckEntityModel<T extends DuckEntity> extends HierarchicalModel<T> implements HeadedModel {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        AnimationHelper.animate(this, entity.idleAnimationState, DuckEntityAnimations.DUCK_WATER_IDLE, ageInTicks);
        AnimationHelper.animate(this, entity.fallingAnimationState, DuckEntityAnimations.DUCK_FALL, ageInTicks);
        AnimationHelper.animate(this, entity.fishingAnimationState, DuckEntityAnimations.DUCK_FISH, ageInTicks);

        if (this.young) {
            AnimationHelper.applyStatic(this, DuckEntityAnimations.BABY_TRANSFORM);
        }
    }
