...
public class DuckGoToWaterGoal extends MoveToBlockGoal {
    ...
    public DuckGoToWaterGoal(Duck duck, double speed) {
    ...
    public boolean canContinueToUse() {
        return this.shouldUse() && this.isValidTarget(this.duck.level, this.blockPos);
    }

    @Override
    public boolean canUse() {
        return this.shouldUse() && super.canUse();
    }
