...
public class GESounds {
    public static final CoreRegistry<SoundEvent> SOUNDS = CoreRegistry.create(Registry.SOUND_EVENT, GeologicExpansion.MOD_ID);
    ...
    private static Supplier<SoundEvent> create(String key) {
        return SOUNDS.register(key, () -> new SoundEvent(new ResourceLocation(GeologicExpansion.MOD_ID, key)));
    }
}